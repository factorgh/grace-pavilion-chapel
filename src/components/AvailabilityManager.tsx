...
const AvailabilityManager = ({ initialAvailability, onSave }: AvailabilityManagerProps) => {
  ...
  const addTwoWeeks = () => {
    ...
    for (let i = 1; i <= 14; i++) {
      ...
      if (dayOfWeek !== 0 && dayOfWeek !== 6) {
        ...
        const existingDay = newAvailability.find(day => day.date === dateString);
    ...
    setAvailability(newAvailability.sort((a, b) => a.date.localeCompare(b.date)));
  };
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
      <div className="p-4 bg-blue-50 dark:bg-blue-900 border-b border-blue-100 dark:border-blue-800 flex justify-between items-center">
        <h2 className="text-lg font-bold text-blue-900 dark:text-blue-100">Manage Pastor Availability</h2>
      ...
      {isEditing ? (
        <div className="p-4">
          <div className="grid md:grid-cols-2 gap-4 mb-6">
            ...
            <div>
              <div className="mb-6">
                <label className="block mb-2 text-gray-700 dark:text-gray-300">New Time Slot</label>
                <div className="flex space-x-2">
                  <select
                    value={newTimeSlot}
              ...
              <div>
                ...
                <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  Adds 9AM-11AM and 1PM-3PM slots for weekdays in the next two weeks
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-gray-200 dark:border-gray-700 pt-4">
            <h3 className="font-bold mb-2 text-gray-800 dark:text-gray-200">Current Availability:</h3>
            ...
            <div key={index} className="mb-4 pb-4 border-b border-gray-100 dark:border-gray-700 last:border-0">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                {day.slots.map((slot, slotIndex) => (
                  <div key={slotIndex} className="flex items-center text-gray-600 dark:text-gray-400">
                    <Clock size={14} className="text-blue-600 dark:text-blue-400 mr-2" />
                    {slot}
                  </div>
                ))}
              </div>
